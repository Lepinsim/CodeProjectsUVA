...
def Perspective_warping(img1, img2, img3):
    ...
    cv2.imwrite('output_homography2.png',output1)
    o = cv2.imread('output_homography2.png',0)    
    
    # master = cv2.imread("example_output1.png", 0)    
    
    
    output_image = o 
    output_name = "output_homography2.png"
...
os.chdir(path)
input_image1 = cv2.imread('output_homography.png', 0)
input_image2 = cv2.imread('output_homography1.png', 0)
input_image3 = cv2.imread('Top_1_x40.jpg', 0) 
